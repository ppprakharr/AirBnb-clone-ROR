class Reservation < ApplicationRecord
  ...
  where(
    "(checkin_date < ? AND checkout_date > ?) OR (checkin_date < ? AND checkout_date > ?) OR (checkin_date > ? AND checkout_date < ?) OR (checkin_date < ? AND checkout_date > ?)",
     checkin_date, checkin_date, checkout_date, checkout_date, checkin_date, checkout_date, checkin_date, checkout_date)
  }
end
