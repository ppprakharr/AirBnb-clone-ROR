...
ActiveRecord::Schema[8.0].define(version: 2024_11_30_171023) do
  ...
  create_table "reservations", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["property_id", "checkin_date", "user_id", "checkout_date"], name: "idx_on_property_id_checkin_date_user_id_checkout_da_18290d847c", unique: true
